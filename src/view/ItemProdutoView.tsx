...
const IMAGENS_PRODUTOS: Record<string, ImageSourcePropType> = {
  ...
  "arrumadinho-completo-large": require("../../assets/images/menu/arrumadinho-completo-large.png"),
      ...
      {carregando ? (
        ...
        >
          ...
          <View style={styles.cardFoto}>
            <Image
              source={IMAGENS_PRODUTOS[produto.imagemGrande || produto.imagem]}
          ...
          <View style={styles.infoSecao}>
            <View style={styles.tituloPrecoLinha}>
              ...
              <View style={styles.badgePreco}>
                <Text style={styles.textoBadgePreco}>{precoFormatado}</Text>
              </View>
            </View>
